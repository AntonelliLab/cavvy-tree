# TODO: add wobble base pair info
...
# Functions ----
partition_write <- function(nbps, flpth) {
...
partition_finder_setup <- function(supermatrix, outdir, nm) {
...
# PartitionFinder ----
matrix_dirs <- file.path(outdir, c('low', 'mid', 'high'))
